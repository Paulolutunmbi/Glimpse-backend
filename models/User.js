...
const userSchema = new mongoose.Schema(
  {
    ...
    settings: {
      ...
      security: {
        ...
        adminAccess: {
          ...
          remainingAttempts: { type: Number, default: 5 },
          lastAttemptAt: { type: Date },
          lastAttemptRoute: { type: String, trim: true },
          lastAttemptIp: { type: String, trim: true },
          lastAttemptUserAgent: { type: String, trim: true },
    ...
    banMeta: { type: mongoose.Schema.Types.Mixed, default: {} },
